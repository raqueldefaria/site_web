...
function cookie_mail_temp(){
  if (isset($_POST['mail']))
  {
    setcookie('mail_temp',$_POST['mail'], time() + 300, "/site_web", "localhost", false, true);
  }
}
...
function cookie_adress_temp(){
  ...
  {
    setcookie('adress_temp',$_POST['adresse'], time() + 300, "/site_web", "localhost", false, true);
  }
}
...
function cookie_codepostal_temp(){
  ...
  {
    setcookie('codepostal_temp',$_POST['codePostal'], time() + 300, "/site_web", "localhost", false, true);
  }
}
...
function cookie_city_temp(){
  ...
  {
    setcookie('city_temp',$_POST['ville'], time() + 300, "/site_web", "localhost", false, true);
  }
}
...
function cookie_country_temp(){
  if (isset($_POST['pays']))
  {
    setcookie('country_temp',$_POST['pays'], time() + 300, "/site_web", "localhost", false, true);
  }
}
