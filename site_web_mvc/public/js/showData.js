function showHousingsFromDb(idUser) {
    ...
    xmlhttp.onreadystatechange = function () {
        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            for (it = 0; it < myObj.length; it++) {
                    txt += "<a href=\"index.php?action=goToRooms&id="+ myObj[it].id_Logement + "\" >" +
                        "<div class='section'>" +
    ...
    xmlhttp.open("POST", "model/showHousingJs.php", true);
...
function showRoomsFromDb(idUser, idLogement) {
    ...
    xmlhttp.onreadystatechange = function() {
        ...
        if (this.readyState == 4 && this.status == 200) {
            myObj = JSON.parse(this.responseText);
            for (it = 0; it < myObj.length; it++) {
                txt += "<a href='index.php?action=goToSensors&id="+ myObj[it].id_Piece + "'>";
                switch (myObj[it].piece_type){
                    case "Garage":
                        txt += "<div class='section'><p>" + myObj[it].piece_nom + "</p><img src='public/images/client/car.png'></div>";
                        break;
                    case "Chambre":
                        txt += "<div class='section'><p>" + myObj[it].piece_nom + "</p><img src='public/images/client/bed.png'></div>";
                        break;
                    case "Cuisine":
                        txt += "<div class='section'><p>" + myObj[it].piece_nom + "</p><img src='public/images/client/cutlery.png'></div>";
                        break;
                    case "Bureau":
                        txt += "<div class='section'><p>" + myObj[it].piece_nom + "</p><img src='public/images/client/desktop.png'></div>";
                        break;
                    case "Salle de Bain":
                        txt += "<div class='section'><p>" + myObj[it].piece_nom + "</p><img src='public/images/client/bathtub.png'></div>";
                        break;
                    case "Toilettes":
                        txt += "<div class='section'><p>" + myObj[it].piece_nom + "</p><img src='public/images/client/toilet.png'></div>";
                        break;
                    case "Salon":
                        txt += "<div class='section'><p>" + myObj[it].piece_nom + "</p><img src='public/images/client/room.png'></div>";
                        break;
                    default:
...
function showSensorsFromDb(idPiece) {
    ...
    xmlhttp.open("POST", "model/showSensorsJs.php", true);
    xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xmlhttp.send("x=" + dbParam);
}
