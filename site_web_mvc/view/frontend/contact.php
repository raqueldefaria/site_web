...
<head>
    <meta charset="utf-8" />
    <link rel="stylesheet" href="public/css/contacter.css" />
    <?= $styleHeader ?>
...
<div id="corps">
    ...
    <div id="paragraphe">
        ...
        <h2><img src="public/images/icone_mail.png" alt"" /> <br />Nous contacter par mail</span></h2>
        ...
        <h2><img src="public/images/logo_telephone.png" alt"" /> <br />Nous contacter par téléphone</h2>
