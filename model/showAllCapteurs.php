...
/*
$data = $db->query("SELECT `capteur/actionneur_type`, `capteur/actionneur_fonction`, piece_nom FROM `capteur/actionneur`, piece
                         WHERE Utilisateur_idUtilisateur=".$_SESSION['userID']." AND id_Logement=".$_SESSION['userID']." AND id_Utilisateur=".$_SESSION['userID']);
